...
@InputType()
class RecommendationCreateNestedManyWithoutMoviesInput {
...
export { RecommendationCreateNestedManyWithoutMoviesInput as RecommendationCreateNestedManyWithoutMoviesInput };
